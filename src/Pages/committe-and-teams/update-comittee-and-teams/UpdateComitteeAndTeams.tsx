  ...
  return (
    <>
      ...
      <div className={`container ${styles.addNewCommittee}`}>
        <div className='row'>
          <div className={`col-md-12 mb-4`} style={{ fontWeight: 'bold' }}>
            معلومات عن اللجنة
          </div>
          <div className='col-md-6 mb-4'>
            <label className={styles.label}>اسم الجهة</label>
            <input
              type='text'
          ...
          <div className='col-md-6 mb-4'>
            <span className={styles.label}>شعار الجهة</span>
            <div
          ...
          <div className='col-md-6 mb-4'>
            <label className={styles.label}>اسم عضو الفريق</label>
            <input
              type='text'
              className='form-control rounded-pill'
          ...
          <div className='col-md-6 mb-4'>
            <label className={styles.label}>صورة عضو الفريق</label>
            <div
              className={`${styles.fileUpload} rounded-pill form-control position-relative`}
            >
              <InsertDriveFileIcon className={styles.fileIcon} />
